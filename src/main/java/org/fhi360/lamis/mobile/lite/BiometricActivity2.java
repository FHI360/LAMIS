...
public abstract class BiometricActivity2 extends BaseActivity implements EnrollmentDialogFragment.EnrollmentDialogListener, SubjectListFragment.SubjectSelectionListener, LicensingStateCallback {
    ...
    private static final String TAG = BiometricActivity2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String hospitalNumber = user2.get("hospitalNumber");

            String patientId = user2.get("patientId");
            System.out.println("patientId2" + patientId);

            mSubjectId.setText(hospitalNumber);
            int count = new BiometricDAO(getApplicationContext()).count(Long.valueOf(patientId));

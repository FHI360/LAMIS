...
import org.fhi360.lamis.mobile.lite.Activities.EditArtCommencement;
...
public final class MainActivity extends BaseActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clientcode = user1.get("clientcode");
        ...
        imageFinger.setOnClickListener(view -> {
            Intent fingerActivity = new Intent(MainActivity.this, FingerActivity.class);
        ...
        enrollSubject.setOnClickListener(view -> {
            ...
            if (subject != null) {
                ...
                Intent intent = new Intent(getApplicationContext(), EditArtCommencement.class);
...
//                String path = folder + "/" + "neurotec-licensing-gui-android.aar";
//                params.putString(ActivationFragment.LICENSES_DIRECTORY_PATH, Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + path);
//                params.putStringArrayList(ActivationActivity.LICENSES, new ArrayList<>(getAllComponentsInternal()));
//                activation.putExtras(params);
